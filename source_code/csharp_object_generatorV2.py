    ...
    def create_object_statement(self, database_name: str, table_name: str,
        ...
        try:
            ...
            for row_data in table_data['data']:
                loop_break_index = 5
                loop_counter = 0
                object_name = self.convert_snake_to_pascal_case(self.format_name(table_name))
                output_sql += f'    {object_name}List.Add( new {object_name}'
                output_sql += ' {\n'
                column_text = ''
                ...
                for loop_columns in range(0, number_of_columns):
                    ...
                    property_name =  self.convert_snake_to_pascal_case(self.format_name(column))
